  ...
  return (
    <div>
      <section className="text-center px-8 py-12">
        <h2 className="text-2xl md:text-5xl font-bold py-1 md:py-5">
          Our Story
        </h2>
        <p className="text-gray-700 dark:text-gray-300 max-w-3xl mx-auto py-1 md:py-3 text-lg">
      ...
      <section className="px-8 md:px-36 space-y-12 py-10">
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
          <div className="md:w-1/2 space-y-2 md:px-14">
            <h3 className="text-2xl font-bold md:py-3">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center space-y-4 md:space-y-0 md:space-x-8">
          <div className="md:w-1/2 space-y-2 md:px-14">
            <h3 className="text-2xl font-bold md:py-3">
        ...
        <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8">
          <div className="md:w-1/2 space-y-2 md:px-14 md:py-3 ">
